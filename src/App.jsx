  ...
  return (
    <div className="app">
      ...
      <main>
        ...
        <section id="alojamiento" className="accommodation-section">
          <div className="container">
            <div className="section-header animate-on-scroll">
        ...
        <section id="viajes-corporativos" className="corporate-section">
          <div className="container">
            <div className="section-header animate-on-scroll">
        ...
        <section id="ubicacion" className="reviews-section">
          <div className="container">
            <div className="section-header animate-on-scroll">
